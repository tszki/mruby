...
MRuby::Build.new do |conf|
  ...
  conf.gem :git => 'https://github.com/take-cheeze/mruby-marshal.git'
  conf.gem :git => 'https://github.com/mattn/mruby-json.git'
  conf.gem :git => 'https://github.com/iij/mruby-mtest.git'
  conf.gem :git => 'https://github.com/matsumoto-r/mruby-oauth.git'
  conf.gem :git => 'https://github.com/matsumoto-r/mruby-mutex.git'
  conf.gem :git => 'https://github.com/charlescui/mruby-cache.git'
  conf.gem :git => 'https://github.com/iij/mruby-pack.git'
  conf.gem :git => 'https://github.com/mattn/mruby-base64.git'

  conf.gem :git => 'https://github.com/tszki/mruby-curl.git'
  conf.gem :git => 'https://github.com/tszki/mruby-semlock.git'
end
